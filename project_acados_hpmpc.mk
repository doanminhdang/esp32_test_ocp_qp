...
# Dang add for compiling acados with HPMPC - BLASFEO:
# -Wno-error=array-bounds
# -Wno-unused-parameter -Wextra -Werror -fPIC
# -Wno-error=parentheses
# -Wno-error=maybe-uninitialized
COMMON_WARNING_FLAGS = -Wall -Werror=all -Wextra \
...
# If any flags are defined in application Makefile, add them at the end.
# For qpoases: -D__SUPPRESSANYOUTPUT__
CFLAGS := $(strip \
	-std=gnu99 \
	$(OPTIMIZATION_FLAGS) \
	$(COMMON_FLAGS) \
